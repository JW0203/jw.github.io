...
function drowmap() {
    ...
    d3.csv("static/bw102_0.8/data/plot_lw.csv", function (error, cities) {	
...
//		console.log(group_info)
		...
		for(i=0;i<filtered.length;i++){
			var loc2 = L.circle([filtered[i].x, filtered[i].y],{color: 'red',fillColor: '#f03',fillOpacity: 0.5,radius: 900}).addTo(map);
